...
class TokenizerTrainer:
    TARGET_MODEL_PATH = 'Tokenizadores/HelBERT-base-raw'
    MAX_SEQ_LENGTH = 512
    VOCAB_SIZE = 30000
    ...
    def __init__(self):
        self.files = [
            PathUtil.build_path('Datasets/HelBERT-base-raw', 'treino.txt'),
            PathUtil.build_path('Datasets/HelBERT-base-raw', 'teste.txt'),
        ]
