from train_lsg_secoes import TrainLsgSecoes
...
def main() -> None:
    params = json.load(open('./configSecoesLsg.json'))
    for setModel in tqdm(params['modelos'], desc="Realizando Cross Validation dos modelos..", colour='red'):
        ...
        classificador = TrainLsgSecoes(batch_size=params['batch_size'], epochs=params['epochs'],
