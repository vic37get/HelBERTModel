...
class ClassificaIndicios:
    def __init__(self, batch_size: int, epochs: int, patience: int, model_name: str, dir_save_metrics: str,
                ...
                max_chunks: int, method: int, tokenizer: str, dataset: str, coluna: str, frozen: bool) -> None:
    ...
    def modelTraining(self, folds: list) -> None:
        ...
        for fold,(train_idx, val_idx) in enumerate(folds):
            ...
            self.classifier = Classifier(input_size = 768, output_size=7, method=self.method, model=self.modelo, tokenizer=self.tokenizer, frozen=self.frozen).to(self.device)
