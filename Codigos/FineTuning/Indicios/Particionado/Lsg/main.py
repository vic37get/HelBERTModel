from train_lsg import TrainLsgIndicios
...
def main() -> None:
    params = json.load(open('./configIndiciosLsg.json'))
    ...
    for setModel in tqdm(params['modelos'], desc="Realizando Cross Validation dos modelos..", colour='red'):
        ...
        classificador = TrainLsgIndicios(batch_size=params['batch_size'], epochs=params['epochs'],
                    ...
                    tokenizer=setModel['tokenizador'], train=params['train'], test=params['test'], val=params['val'],
