from trainSplitedIndicios import ClassificaIndicios
import sys
sys.path.insert(0, '../../../')
...
def main() -> None:
    ...
    for setModel in params['modelos']:
        ...
        val_dataset = MyDataset(classificador.validacao, labels, classificador.coluna, classificador.tokenizer, classificador.device, classificador.modelo)
        test_dataset = MyDataset(classificador.teste, labels, classificador.coluna, classificador.tokenizer, classificador.device, classificador.modelo)
